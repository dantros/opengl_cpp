...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("../graphics/shaders/lightMVPShader.vs", "../graphics/shaders/lightMVPShader.fs");
    Shader lightCubeShader("../graphics/shaders/colorMVPShader.vs", "../graphics/shaders/colorMVPShader.fs");
