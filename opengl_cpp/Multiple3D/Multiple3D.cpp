...
#include "../graphics/cameras/cameraFirstPerson.h"
...
int main()
{
    ...
    // --------------------
    string title = "Multiple 3D Objects";
    ...
    // ------------------------------------
    Shader mpvTexShader("../graphics/shaders/MVPTexShader.vs", "../graphics/shaders/MVPTexShader.fs");
    ...
    unsigned char* data = stbi_load("../assets/box.png", &width, &height, &nrChannels, 0);
    if (data)
    {
